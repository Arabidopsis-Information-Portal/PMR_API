...
```
$ cd ~/git/scienceapps/PMR_API/services/boxplot_api
$ git pull
```
...
### Deploy Boxplot Service

#### Deploy Service

```
$ pwd
$ ~/git/scienceapps/PMR_API/services/boxplot_api
$ echo $NS
pmr-dev
$ curl -sk -L -X POST $API/$NS/services -F "git_repository=https://github.com/Arabidopsis-Information-Portal/PMR_API.git" -F "metadata=services/boxplot_api" -H "Authorization: Bearer $TOKEN"
```
...
```
{
    ...
    "result": {
        "list_url": "https://api.araport.org/community/v0.3/pmr-dev/pmr_boxplot_api_v0.4/list",
        "notification": "",
        "search_url": "https://api.araport.org/community/v0.3/pmr-dev/pmr_boxplot_api_v0.4/search",
        "state_url": "https://api.araport.org/community/v0.3/pmr-dev/pmr_boxplot_api_v0.4"
    },
    "status": "success"
}
```
...
```
$ curl -skL -X GET -H "Authorization: Bearer $TOKEN" "$API/$NS/pmr_boxplot_api_v0.4"
```
...
```
$curl -v -H "Authorization: Bearer $TOKEN" "https://api.araport.org/community/v0.3/$NS/pmr_boxplot_api_v0.4/search?experimentID=106&platformID=84&metaboliteID=4349"
```
...
< Link: https://api.araport.org/community/v0.3/pmr-dev/pmr_boxplot_api_v0.4/prov/38f2d971bc624abe807733a518cc6362; rel="http://www.w3.org/ns/prov#has_provenance"
...
"metadata": {"time_in_main": 0.08911585807800293},
"status": "success"}
...
```
$curl -v -H "Authorization: Bearer $TOKEN" "https://api.araport.org/community/v0.3/pmr/pmr_boxplot_api_v0.4/list?experimentID=106&platformID=84"
```
...
```
$curl -Lk -X DELETE -H "Authorization: Bearer $TOKEN" https://api.araport.org/community/v0.3/$NS/pmr_boxplot_api_v0.4
```
...
3. API documentation is generated in [API Doc Folder.](https://cdn.rawgit.com/Arabidopsis-Information-Portal/PMR_API/d7c882cd7337635dba872cbe3baa47762486c896/doc/api/boxplot/index.html)
