...
```
$ cd ~/git/scienceapps/PMR_API/services/experiments_api
$ git pull
```
...
```
$ pwd
$ ~/git/scienceapps/PMR_API/services/experiments_api
$ echo $NS
pmr-dev
$ curl -sk -L -X POST $API/$NS/services -F "git_repository=https://github.com/Arabidopsis-Information-Portal/PMR_API.git" -F "metadata=services/experiments_api" -H "Authorization: Bearer $TOKEN"
```
...
```
{
    ...
    "result": {
        "list_url": "https://api.araport.org/community/v0.3/pmr-dev/pmr_experiments_api_v0.4/list",
        "notification": "",
        "search_url": "https://api.araport.org/community/v0.3/pmr-dev/pmr_metabolite_api_v0.4/search",
        "state_url": "https://api.araport.org/community/v0.3/pmr-dev/pmr_metabolite_api_v0.4"
    },
    "status": "success"
}
```
...
```
$ curl -skL -X GET -H "Authorization: Bearer $TOKEN" "$API/$NS/pmr_experiments_api_v0.4"
```
...
```
 HTTP/1.1 200 OK
< Date: Mon, 01 Feb 2016 03:30:30 GMT
* Server WSO2-PassThrough-HTTP is not blacklisted
< Server: WSO2-PassThrough-HTTP
< Link: https://api.araport.org/community/v0.3/pmr-dev/pmr_experiments_api_v0.4/prov/a61852c50107430db72ab633327e9826; rel="http://www.w3.org/ns/prov#has_provenance"
...
<
{
  ...
  "metadata": {
    "time_in_main": 0.25940704345703125
  },
  "status": "success"
}
...
```
$ curl -v -H "Authorization: Bearer $TOKEN" "https://api.araport.org/community/v0.3/pmr/pmr_experiments_api_v0.4/list"
```

```
HTTP/1.1 200 OK
< Date: Mon, 01 Feb 2016 03:34:08 GMT
* Server WSO2-PassThrough-HTTP is not blacklisted
< Server: WSO2-PassThrough-HTTP
< Link: https://api.araport.org/community/v0.3/pmr-dev/pmr_experiments_api_v0.4/prov/a6a578394ee34845bec22f3f2c56d4ae; rel="http://www.w3.org/ns/prov#has_provenance"
< Access-Control-Allow-Headers: Origin, X-Requested-With, Content-Type, Accept, Authorization, Content-Range, Range
< Access-Control-Allow-Methods: GET, POST, PUT, DELETE, OPTIONS
< Content-Type: application/json
< Access-Control-Allow-Origin: *
...
<
{
  ...
  "metadata": {
    "time_in_main": 0.05842399597167969
  },
  "status": "success"
}* Closing connection 0
```
...
```
$curl -Lk -X DELETE -H "Authorization: Bearer $TOKEN" https://api.araport.org/community/v0.3/$NS/pmr_experiments_v0.4
```
...
3. API documentation is generated in [API Doc Folder.](https://cdn.rawgit.com/Arabidopsis-Information-Portal/PMR_API/d7c882cd7337635dba872cbe3baa47762486c896/doc/api/experiments/index.html)
