...
### Deploy Metabolite Service

#### Deploy Service

```
$ pwd
$ ~/git/scienceapps/PMR_API/services/metabolite_api
$ echo $NS
pmr-dev
$ curl -sk -L -X POST $API/$NS/services -F "git_repository=https://github.com/Arabidopsis-Information-Portal/PMR_API.git" -F "metadata=services/metabolite_api" -H "Authorization: Bearer $TOKEN"
```
...
```
{
    ...
    "result": {
        "list_url": "https://api.araport.org/community/v0.3/pmr-dev/pmr_metabolite_api_v0.4/list",
        "notification": "",
...
```
$ curl -skL -X GET -H "Authorization: Bearer $TOKEN" "$API/$NS/pmr_metabolite_api_v0.4"
```
...
```
$curl -v -H "Authorization: Bearer $TOKEN" "https://api.araport.org/community/v0.3/$NS/pmr_metabolite_api_v0.4/search?experimentID=106&platformID=84&metaboliteID=4349"
```
...
```
$curl -Lk -X DELETE -H "Authorization: Bearer $TOKEN" https://api.araport.org/community/v0.3/$NS/pmr_metabolite_api_v0.4
```
