...
# This function returns the metabolites base url to use by the search endpoint
def get_search_base_url():
    """Return the metabolites base url
    
    :rtype: string
    :return: Returns the metabolites base url
    
    """
    return 'http://pmr-webapi.gdcb.iastate.edu/pmrWebApi/api/v1/metabolites/list'

# This function returns the metabolites base url to use by the list endpoint
